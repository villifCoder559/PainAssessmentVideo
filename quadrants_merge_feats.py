...
if args.csv_path is None:
  args.csv_path = "partA/starting_point/samples.csv"
...
if 'caer' in csv_path.lower():
  #remove train from list_subject_name
  list_subject_name = [s.replace('train/', '') for s in list_subject_name]
  list_subject_name = [s.replace('validation/', '') for s in list_subject_name]
  list_subject_name = [s.replace('test/', '') for s in list_subject_name]
