...
BASE_INIT_PATH="TRAIN_tests/history_run_AGE_5_fold_rnc_frontal_3891361_ATTENTIVE_JEPA_harlock_1772110228/1772110230732_DFER_MEAN_TEMPORAL_SPATIAL_NONE_SLIDING_WINDOW_ATTENTIVE_JEPA/train_ATTENTIVE_JEPA/k0_cross_val/k0_cross_val_sub_0"

EPOCHS=(-1 30 60 90 150 180)
...
do
    ...
    CUDA_VISIBLE_DEVICES=$GPU python3 train_model.py \
        ...
        --global_folder_name TRAIN_tests/history_run_AGE_5_fold_2nStage_frontal_${E}_MLPLINEAR \
